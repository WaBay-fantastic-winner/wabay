<template>
  ...
  <div class='flex justify-end mx-2 text-3xl'>
    <em><span>NT$ </span><span id="sum">{{ additional_donate_price }}</span></em>
  </div>
  <div class='mt-3'>
    <button class='w-full px-6 py-2 text-white bg-purple-400 hover:bg-purple-300 rounded-3xl'>直接贊助</button>
  </div>
</template>
